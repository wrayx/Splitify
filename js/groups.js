...
function addMemberInput() {
  ...
  node.innerHTML +=
    '<input type="text" name="members[]"  class="member-email" required>\n' +
...
//     .getElementById("delete-modal-trigger-" + id)
//     .parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.id.split(
//       "-"
//     )
//     .pop();
//   //   console.log("group id: " + groupid);
//   let params = `memberid=${id}&groupid=${groupid}`;
//   console.log(params);
...
//       remainingModal.parentElement.parentElement.removeChild(
